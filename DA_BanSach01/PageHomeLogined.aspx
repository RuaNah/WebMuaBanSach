<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PageHomeLogined.aspx.cs" Inherits="PageHomeLogined" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
                    ...
                    <asp:DataList ID="DataFull" runat="server" RepeatColumns="4">
                     <ItemTemplate>
